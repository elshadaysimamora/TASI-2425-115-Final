...
class ChatTest extends Command
{
    ...
    public function handle()
    {
        ...
        $prompt = "Jelaskan prosedur jika sakit saat jam akademik dan perlu kembali ke asrama lebih awal, serta langkah-langkah yang harus diambil jika membutuhkan istirahat atau perawatan.";
